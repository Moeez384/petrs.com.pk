...
function SaveSignup_4()
{
    ...
    ValidateField('txt-frmdate', 'err-frmdate');
    ValidateField('txt-todate', 'err-todate');
    ValidateField('txt-post', 'err-post');
    ValidateField('txt-dept', 'err-dept');
    ValidateField('txt-deptype', 'err-deptype');
    ValidateField('txt-bps', 'err-bps');
    ValidateField('txt-salary', 'err-salary');
    ValidateField('txt-duties', 'err-duties');
