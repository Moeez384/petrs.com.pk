  ...
  <div id="content_section">
      <div class="contentblock">
          <div class="search_course pz-center">
              <div class="box">
                <h5 class="main-heading">Balochistan Residentional College Quetta (B R C)
Entry Test 2021 class VII</h5>

 <h1 class="main-heading"> QUETTA CENTER </h1>
                  <div class="form">
                    <form class="box" action="<?php echo site_url('RollNoSlip/getSlip')?>" method="post">
<ul class="inquiryform">

<a href="<?php echo base_url('BRC/QuettaRollNoSlip'); ?>">
<button type="button" class="btn btn-primary">Search By CNIC Number</button>
</a>
</br></br>
<h5> Enter Your Contact Number Without First Zero Example (0300000000</h5>

<li><input type="text" required name="Phone" placeholder="3330000000"></li>
<br>
<!-- <h4>Please Enter Your Phone Number with dashes '-'</h4> -->
<div>
...
<div class="clear"></div>
 ...
 <?php
if ($this->session->flashdata('test1')) {
  ?>
  <script>
