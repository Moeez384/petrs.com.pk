...
Entry Test 2021 class VII</h5>
 ...
 <h1 class="main-heading"> LORAlAI CENTER Result</h1>
                  <div class="form">
                    <form class="box" action="<?php echo site_url('LoralaiResult/viewResult')?>" method="post">
<ul class="inquiryform">

<a href="<?php echo base_url('LoralaiResult'); ?>">
<button type="button" class="btn btn-primary">Search By CNIC</button>
</a>

<h5> Enter Your Contact Number Without First Zero </h5>
