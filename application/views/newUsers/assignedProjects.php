...
<table id="tb" class="table table-bordered table-hover" style="width: 100%; color:black">
      <thead> 
        <?php
if ($this->session->flashdata('delete2587')) {
  ?>
  <div align="center" style="color: #FFF" class="btn-success">
    <?php
    echo $this->session->flashdata('delete2587');
    ?>
    </div>
    <?php
}
?>
  <?php
if ($this->session->flashdata('delete36987')) {
  ?>
  <div align="center" style="color: #FFF" class="btn-danger">
    <?php
    echo $this->session->flashdata('delete36987');
    ?>
    </div>
    <?php
}
?>    	
      ...
      <th class="coursename colr text-center">project</th>
    ...
    <tr>
      ...
      <td><a href="<?php echo base_url('Admin/UserAdmin/deleteLinks') ?>/<?php echo $res->uid;?>/<?php echo $res->pid ?>">Delete</td>
      </tr>
<?php } ?>
    </table>
</div>
