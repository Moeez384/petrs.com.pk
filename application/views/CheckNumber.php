...
Entry Test 2021 class VII</h5>
 ...
 <h1 class="main-heading"> LORAlAI CENTER</h1>
                  <div class="form">
                    <form class="box" action="<?php echo site_url('RollNoSlip/check')?>" method="post">
<ul class="inquiryform">

<a href="<?php echo base_url('BRC/LoralaiRollNoSlip'); ?>">
