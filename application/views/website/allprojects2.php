...
<body>
  ...
  <div class="">
    ...
    <div class="top_search pz_search">
      <ul>
...
<table class="rtable paginated" id="tb">
  <tr>
    <th class="code colr">Sr. No.</th>
    <th class="coursename colr">Project Name</th>
    <th class="time colr">Last Date</th>
    <th class="location colr">Download</th>
    <th class="location colr">Status</th>
  </tr>
  <?php 
  ...
  ?>
  <tr>
    <td class="code colr"><?php echo $i; ?></td>
    <td class="coursename colr"><?php echo $pr->name; ?></td>
    <td class="time colr"><?php echo $pr->last_date; ?></td>
    <?php if(($pr->attachment) != '') { ?>
    <td class="location colr"><a href="<?php echo base_url()?>uploads/projects/<?php echo $pr->attachment; ?>" class="colr"><?php echo 'Download File'?></a></td>
  <?php } else { ?>
    <td class="location colr"><?php echo ''; ?></td>
  <?php } ?>
    <td class="location colr"><?php echo $status_val; ?></td>
  </tr>
  <?php }} ?>
</table>
