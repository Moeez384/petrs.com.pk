...
<body class="bg-light">
	<div class="container bg-white" style="border: 1px">
		<div class="text-center">
			...
			<div class="row">
				<div class="col col-4">
					<label class="text-dark" style="font-weight: bold;">Roll no: </label>
					<label><?php echo $user_id != '' ? $user_id : ''; ?></label>

				</div>
				<div class="col col-4" style="float: left;">
					<label class="text-dark" style="font-weight: bold;">Center name: </label>
					<label><?php echo $center != '' ? $center : ''; ?></label>
				</div>
				<?php 
			...
			<div class="row bg-light mt-2">
				<div class="col text-dark" style="font-weight: bold">Test Date: </div>
				<div class="col"><?php echo $this->WebsiteModel->test_date3($post_id) != '' ? $this->WebsiteModel->test_date3($post_id) : ''; ?></div>
			</div>
			<div class="row bg-light mt-2">
				<div class="col text-dark" style="font-weight: bold">Test Time: </div>
				<div class="col"><?php echo $this->WebsiteModel->get_post_all($post_id)['test_time'] != '' ? $this->WebsiteModel->get_post_all($post_id)['test_time'] : ''; ?></div>
			</div>
			<?php }} ?>
			...
			<div class="row bg-light mt-2">
				<div class="col text-dark" style="font-weight: bold">Challan Date: </div>
				<div class="col"><?php echo $dt->challan_date != '' ? $dt->challan_date : ''; ?></div>
			</div>
			<?php } ?>
			<br><br>
			<div class="row">
