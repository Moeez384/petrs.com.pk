...
<table id="tb" class="table table-bordered table-hover" style="width: 100%; color:black">
    ...
    <th class="coursename colr text-center">Ad no</th>
    ...
    <th class="location colr text-center">Apply Online</th>
  </tr>
    </thead>
  <!-- <?php 
  $projects = $this->WebsiteModel->fetch_latest_projects();
    if($projects) {
    $i= 0;
    foreach($projects as $pr) {
      ...
      if($pr->status == 0) {
        ...
        $fetch_ad = $this->WebsiteModel->fetch_ad($pr->advertisement);
  ?> -->
  <tr>
    <td class="code colr text-center"><?php echo $i; ?></td>
    <td class="coursename colr text-center"><?php echo $pr->name; ?></td>
    <td class="coursename colr text-center"><?php echo $fetch_ad; ?></td>
    <td class="time colr text-center"><?php echo $pr->last_date; ?></td>
    <?php if(($pr->attachment) != '') { ?>
    <td class="location colr text-center"><a href="<?php echo base_url()?>uploads/projects/<?php echo $pr->attachment; ?>" class="colr"><?php echo 'Download File'?></a></td>
  <?php } else { ?>
    <td class="location colr text-center"><?php echo ''; ?></td>
  <?php } ?>
    <td class="location colr text-center"><?php echo $status_val; ?></td>
    <td class="location colr text-center"><a class="" href="<?php echo base_url('ApplyOnline')?>">Apply Online</a> </td>
  </tr>
  <!-- <?php }} ?> -->
    </table>
<div class="clear"></div>
