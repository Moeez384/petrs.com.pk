...
<table id="tb" class="table table-bordered table-hover" style="width: 100%; color:black">
      ...
      <th class="coursename colr text-center">Post Name</th>
      <th class="location colr text-center">Result</th>
...
<!-- <tr>
    ...
    <tr>
      <td class="code colr text-center">1</td>
      <td class="code colr text-center">Balochistan Residential College Loralai (Quetta Center)</td>
      <td class="code colr text-center">Class 7th</td>
      <td class="code colr text-center"><a href="<?php echo base_url('/QuettaResult') ?>">Click Here To View</a></td>
    </tr>
    <tr>
      <td class="code colr text-center">1</td>
      <td class="code colr text-center">Balochistan Residential College Loralai (Loralai Center)</td>
      <td class="code colr text-center">Class 7th</td>
      <td class="code colr text-center"><a href="<?php echo base_url('/LoralaiResult') ?>">Click Here To View</a></td>
    </tr>
    </table>
<div class="clear"></div>
<div class="clear"></div>
