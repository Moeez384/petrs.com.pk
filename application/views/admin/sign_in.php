...
<body>
	<div class="container">
      ...
      <div class="form-wrapper has-feedback text-center">
		...
		<br>
			<!--<a href="<?php echo base_url()?>admin/Signin/sign_up" style="font-size: 14px; font-style: italic; text-decoration: underline; padding-left: 25%">Not registered? Sign Up/Register</a>-->
	<br>
		<hr>
