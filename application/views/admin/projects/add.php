...
<body style="background-color: ghostwhite">
  ...
  <div class="card-body table-responsive">
    <h3 style="color: #05386B;" class="text-center">ADD PROJECT</h3>
  </div>
</div>
  ...
  <div class="card border border-0 rounded-0 shadow ml-5 mr-5">
    <div class="container">
      ...
      <div class="card-body">
        ...
        <?php } ?>
        <form method="post" action="<?php echo base_url()?>admin/Projects/save" enctype="multipart/form-data">
        <div class="container ml-2">
        <div class="row"> 
          <div class="col col-sm">
            <p class="mt-3 text-dark" style="font-size: 17px">Project Name:
            <input class="form-control mt-1 rounded-3" id="txt-name" type="text" name="name" style="width: 100%"></p>
        ...
        <div class="row"> 
          ...
          <div class="col col-sm">
            ...
            <!-- <input class="ml-1 mt-1 form-control rounded-3" type="text" id="txt-ad" name="adv" style="width: 100%"> -->
            </p>
        ...
        <div class="row">
          ...
          <div class="col col-sm">
            ...
            <input class="form-control mt-1 rounded-3" type="text" id="txt-center" name="center" style="width: 100%">
            </p>
        ...
        <div class="row">
          <div class="col col-sm">
            <button style="float:right" class="btn btn-primary rounded-3 pl-3 pr-3" name="save" onclick="return add_project()"><i class="fa fa-check-square" aria-hidden="true"></i> Save</button>
          </div>
        </div>
      </div>
    </div>
...
<script src="<?php echo base_url()?>assets/scripts/admin/projects/add.js"></script>
