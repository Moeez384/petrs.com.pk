...
<body style="background-color: ghostwhite">
  ...
  <div class="card-body table-responsive">
    <h3 style="color: #05386B;" class="text-center">ADD ASSOCIATE</h3>
  </div>
</div>
  ...
  <div class="card border border-0 rounded-0 shadow ml-5 mr-5">
    <div class="container">
      ...
      <div class="card-body">
        ...
        <?php } ?>
        <form method="post" action="<?php echo base_url()?>admin/Associates/update">
          <input class="form-control mt-1 rounded-3" id="txt-id" type="text" name="id" value="<?php echo $id; ?>" style="width: 100%" hidden>
        <div class="container ml-2">
        <div class="row"> 
          <div class="col col-sm">
            <p class="mt-3 text-dark" style="font-size: 17px">UNIVERSITY / D.A.IS
            <input class="form-control mt-1 rounded-3" id="txt-title" type="text" name="title" value="<?php echo $uni_name; ?>" style="width: 100%"></p>
            <span class="spn-err" id="err-title" style="color: red; display: none;">Please provide niversity / D.A. IS</span>
          </div>
        </div>
        <br>
        <div class="row">
          <div class="col col-sm">
            <button style="float:right" class="btn btn-primary rounded-3 pl-3 pr-3" name="save" onclick="return add_associate()"><i class="fa fa-check-square" aria-hidden="true"></i> Save</button>
          </div>
        </div>
      </div>
    </div>
...
<script src="<?php echo base_url()?>assets/scripts/admin/associates/add.js"></script>
