  ...
  <div class="card border border-0 rounded-0 shadow ml-5 mr-5">
    <div class="container">
      ...
      <div class="card-body">
        ...
        <?php } ?>
        <form method="post" action="<?php echo base_url()?>admin/Posts/update" enctype="multipart/form-data">
        ...
        <div class="row"> 
          <div class="col col-sm">
            ...
            <input class="form-control mt-1 rounded-3" id="txt-title" value="<?php echo $title; ?>" type="text" name="title" style="width: 100%"></p>
        ...
        <div class="row">
          <div class="col col-sm">
            ...
            <input class="form-control mt-1 rounded-3" id="txt-center" value="<?php echo $center != '' ? $center : ''; ?>" type="text" name="center" style="width: 100%"></p>
            <!-- <span class="spn-err" id="err-title" style="color: red; display: none;">Please provide title</span> -->
          </div>
          <div class="col col-sm">
            <p class="mt-3 text-dark" style="font-size: 17px">Test Date:
            <input class="form-control mt-1 rounded-3" id="txt-date" value="<?php echo $test_date != '' ? $test_date : ''; ?>" type="date" name="date" style="width: 100%"></p>
          ...
          <div class="col col-sm">
            ...
            <input class="form-control mt-1 rounded-3" id="txt-time" value="<?php echo $test_time != '' ? $test_time : ''; ?>" type="time" name="time" style="width: 100%"></p>
