...
<body style="background-color: ghostwhite">
  ...
  <div class="card-body table-responsive">
    <h3 style="color: #05386B;" class="text-center">ADD CEO MESSAGE</h3>
  </div>
</div>
  ...
  <div class="card border border-0 rounded-0 shadow ml-5 mr-5">
    <div class="container">
      ...
      <div class="card-body">
        ...
        <?php } ?>
        <form method="post" action="<?php echo base_url()?>admin/CeoMessage/save" enctype="multipart/form-data">
