...
<body style="background-color: ghostwhite">
  ...
  <div class="card-body table-responsive">
    <h3 style="color: #05386B;" class="text-center">Update CSR</h3>
  </div>
</div>
  ...
  <div class="card border border-0 rounded-0 shadow ml-5 mr-5">
    <div class="container">
      ...
      <div class="card-body">
        ...
        <?php } ?>
        <form method="post" action="<?php echo base_url()?>admin/CSR/update" enctype="multipart/form-data">
          <input class="form-control mt-1 rounded-3" id="txt-id" type="text" name="id" value="<?php echo $id; ?>" style="width: 100%" hidden>
        <div class="container ml-2">
        <div class="row"> 
          <div class="col col-sm">
            <p class="mt-3 text-dark" style="font-size: 17px">CSR Title:
          ...
          <div class="col col-sm">
            ...
            <textarea class="form-control mt-1 rounded-3" id="txt-detail" name="detail" style="width: 100%"><?php echo $details != '' ? $details : ''; ?></textarea></p>
